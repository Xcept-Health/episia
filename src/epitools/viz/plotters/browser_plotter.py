"""
viz/plotters/browser_plotter.py - Browser export utilities for EpiTools.
...
Usage::
    ...
    from epitools.viz.plotters.browser_plotter import save_html, to_react_props
...
def to_react_props(fig: Any) -> Dict[str, Any]:
    ...
    Usage in React::
        ...
        const props = await fetchEpiToolsProps('/api/plot/epicurve');
